...
var header = {
  ...
  salary: '600$ в місяць',
  adress: 'проспект Науки, 9б, Харків',
}
var footer = {
  social: {
    email: {
          ...
          projects: [
            {
              ...
              about:
                'A digital platform to publish, buy, lease or sell real',
              stacks: [
                {
                  name: 'React.js',
                },
              ...
              awards: [
                {
                  name: 'From the idea to the prototype, to the product',
                },
                {
                  name: 'Expert advice for transformation of products',
                },
              ],
              stackAmoGnt: 3,
              awardAmoGnt: 5,
...
router.get('/bootstrap-fild', function (req, res) {
  // res.render генерує нам HTML сторінку

  //            ↙ cюди вводимо назву файлу з сontainer
  res.render('bootstrap-fild', {
    layout: 'bootstrap',
